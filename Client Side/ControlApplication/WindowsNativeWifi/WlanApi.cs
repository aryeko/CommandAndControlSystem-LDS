...
namespace WindowsNativeWifi
{
    ...
    public class WlanClient : IDisposable
    {
        ...
        public class WlanInterface
        {
            ...
            public void ConfigureHostedNetwork(Wlan.Dot11Ssid ssid, uint maxNumberOfPeers = 100)
            {
                Wlan.WlanHostedNetworkConnectionSettings hostedNetworkConnectionSettings =
                    new Wlan.WlanHostedNetworkConnectionSettings
                    {
                        dot11Ssid = ssid,
...
/*
                ...
                */
                ...
                {
                    Wlan.ThrowIfError(
                        Wlan.WlanHostedNetworkSetProperty(
                            client.clientHandle,
                            Wlan.WlanHostedNetworkOpcode.WlanHostedNetworkOpcodeConnectionSettings,
                            (uint)Marshal.SizeOf(hostedNetworkConnectionSettings),
                ...
                finally
                {
                    ...
                    Marshal.FreeHGlobal(hostedNetworkConnectionSettingsPtr);
                }
            }
            ...
            public void SetHostedNetworkInterfaceState(bool enable)
            {
                ...
                try
                {
                    Wlan.ThrowIfError(
                        Wlan.WlanHostedNetworkSetProperty(
                            client.clientHandle,
                            Wlan.WlanHostedNetworkOpcode.WlanHostedNetworkOpcodeEnable,
            ...
            public void StartHostedNetwork()
            {
                ...
                {
                    Wlan.ThrowIfError(
                        Wlan.WlanHostedNetworkStartUsing(client.clientHandle, out reason, IntPtr.Zero));
                }
                finally
                {
                    Console.WriteLine(reason.ToString());
            ...
            public void StopHostedNetwork()
            {
                ...
                {
                    Wlan.ThrowIfError(
                        Wlan.WlanHostedNetworkStopUsing(client.clientHandle, out reason, IntPtr.Zero));
                }
                finally
                {
                    Console.WriteLine(reason.ToString());
