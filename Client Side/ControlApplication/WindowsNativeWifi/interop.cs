...
namespace WindowsNativeWifi
{
    ...
    public static class Wlan
    {
        ...
        #region hostedNetworkData
        public enum WlanHostedNetworkReason
        {
            WlanHostedNetworkReasonSuccess = 0,
            WlanHostedNetworkReasonUnspecified,
            WlanHostedNetworkReasonBadParameters,
            WlanHostedNetworkReasonServiceShuttingDown,
            WlanHostedNetworkReasonInsufficientResources,
            WlanHostedNetworkReasonElevationRequired,
            WlanHostedNetworkReasonReadOnly,
            WlanHostedNetworkReasonPersistenceFailed,
            WlanHostedNetworkReasonCryptError,
            WlanHostedNetworkReasonImpersonation,
            WlanHostedNetworkReasonStopBeforeStart,
            WlanHostedNetworkReasonInterfaceAvailable,
            WlanHostedNetworkReasonInterfaceUnavailable,
            WlanHostedNetworkReasonMiniportStopped,
            WlanHostedNetworkReasonMiniportStarted,
            WlanHostedNetworkReasonIncompatibleConnectionStarted,
            WlanHostedNetworkReasonIncompatibleConnectionStopped,
            WlanHostedNetworkReasonUserAction,
            WlanHostedNetworkReasonClientAbort,
            WlanHostedNetworkReasonApStartFailed,
            WlanHostedNetworkReasonPeerArrived,
            WlanHostedNetworkReasonPeerDeparted,
            WlanHostedNetworkReasonPeerTimeout,
            WlanHostedNetworkReasonGpDenied,
            WlanHostedNetworkReasonServiceUnavailable,
            WlanHostedNetworkReasonDeviceChange,
            WlanHostedNetworkReasonPropertiesChange,
            WlanHostedNetworkReasonVirtualStationBlockingUse,
            WlanHostedNetworkReasonServiceAvailableOnVirtualStation
        }

        /// <summary>
        /// The WlanHostedNetworkOpcode enumerated type specifies the possible values of the operation code
        /// for the properties to query or set on the wireless Hosted Network.
        /// </summary>
